...
def find_equilibrium_TU(n, delta, rho, r, production_function, fig_name, tol=1e-12, distribution="uniform", mu=0.5, sigma=0.1):
...
if __name__ == '__main__':
    ...
    fig_name = "matching_set_TU.pdf"
    find_equilibrium_TU(n, delta, rho, r, production_function, fig_name, tol, "normal", 0.5, 0.1)
